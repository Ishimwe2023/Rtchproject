       ...
       <div class="contents">
        ...
        <div class="slide-contents">
         ...
         <?php
          ...
          //query
          $done=mysqli_query($connect,"select r_id,description,time,date,b_plate_no from direction,route,buss where
           route.d_id=direction.d_id and route.b_id=buss.b_id and r_id=$id");
...
<div class="card">
        ...
        <td><?php echo $data['b_plate_no']?></td>
            ...
            <a href="booking.php?id=<?php echo $data['r_id'];?>">book</a>
